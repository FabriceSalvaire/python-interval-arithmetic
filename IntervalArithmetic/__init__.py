...
class Interval(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #     self.is_left_open = True
        # if self.sup == FloatPlusInfinity:
        #     self.is_right_open = True
...
class IntervalInt(Interval):
    ...
    @property
    def is_left_open(self):
        return self.inf == IntMinusInfinity or self._is_left_open

    @property
    def is_right_open(self):
        return self.sup == IntPlusInfinity or self._is_right_open
